    ...
    <div className="rounded-xl border border-gray-800 bg-gray-900/80 p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2">
        {smokeRoutes.map(([label, path]) => (
          <Link key={path} to={path} className="rounded-lg border border-gray-800 bg-gray-950/60 px-3 py-2 text-xs text-gray-300 hover:border-emerald-500/30 hover:text-white transition-colors">
